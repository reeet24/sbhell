...
public enum ModArmorMaterial implements ArmorMaterial {
    STEEL(SbHell.MOD_ID + ":steel", 33, new int[]{3, 6, 8, 3}, 50, SoundEvents.ARMOR_EQUIP_IRON, 2.0F, 0.0F, () -> {
        return Ingredient.of(ItemInit.STEEL_INGOT.get());
    }),

    FERROTITANIUM(SbHell.MOD_ID + ":ferrotitanium", 37, new int[]{3, 6, 8, 3}, 50, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> {
